        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg flex items-center justify-center shadow-lg border border-white/20">
            ...
            {selectedSpeaker ? (
              ...
              <div className="h-[calc(100vh-8rem)] flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-to-r from-white/10 to-white/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-white/30 shadow-xl backdrop-blur-sm">
                  ...
                  <div className="flex justify-center space-x-6">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-white/10 to-white/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-white/30 backdrop-blur-sm">
