  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-gray-100">
      ...
      <main className="flex max-w-7xl mx-auto">
        {/* 左侧时间轴 - 增加宽度到w-80 */}
        <aside className="w-80 flex-shrink-0 bg-gray-900/80 backdrop-blur-sm border-r border-gray-700/50">
        ...
        <div className="flex-1 flex flex-col">
            ...
            {selectedSpeaker ? (
              ...
              <div className="h-[calc(100vh-8rem)] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-100 mb-2">选择分享者</h3>
          ...
          <div className="p-6 bg-gray-900/50 backdrop-blur-sm border-t border-gray-700/50">
            <div className="rounded-2xl bg-gray-900/70 border border-gray-700 shadow-[0_0_15px_rgba(251,146,60,0.3)] overflow-hidden">
              <div className="p-6">
                <h3 className="text-lg font-semibold text-gray-100 mb-4 flex items-center">
