  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="flex max-w-7xl mx-auto">
        {/* 左侧时间轴 */}
        <aside className="w-80 flex-shrink-0 bg-gray-900 border-r border-gray-800">
          ...
          <div className="flex-1 p-6">
            {selectedSpeaker ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
                {/* 左栏：嘉宾分享卡片 */}
                <div className="rounded-xl bg-gray-800 border border-gray-700 shadow-xl overflow-hidden">
                  <div className="p-6">
              ...
              <div className="h-[calc(100vh-8rem)] flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-blue-500/30 shadow-xl">
                  ...
                  <div className="flex justify-center space-x-6">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-blue-600/20 to-blue-700/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-blue-500/30">
                    ...
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-600/20 to-purple-700/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-purple-500/30">
                    ...
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-orange-600/20 to-red-600/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-orange-500/30">
