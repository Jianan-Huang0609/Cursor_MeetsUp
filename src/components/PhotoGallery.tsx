    ...
    return (
      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">照片 {index + 1}</p>
          <p className="text-xs text-gray-400 mt-1">示例图片</p>
        </div>
      </div>
    );
  };
        ...
        {selectedImage && (
          ...
          >
            ...
            <div className="h-full flex items-center justify-center p-8">
              <div className="max-w-full max-h-full bg-white rounded-lg shadow-2xl p-8">
                <div className="text-center">
                  <svg className="w-24 h-24 mx-auto mb-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <p className="text-lg text-gray-700 mb-2">照片 {currentImageIndex + 1}</p>
                  <p className="text-sm text-gray-500">示例图片预览</p>
                </div>
              </div>
            </div>
