        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center shadow-[0_0_10px_rgba(6,182,212,0.5)]">
          ...
          <div className="flex-1 p-4">
            {selectedSpeaker ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-full">
                {/* 左栏：嘉宾分享卡片 */}
                <div className="rounded-2xl bg-gray-900/70 border border-gray-700 shadow-[0_0_15px_rgba(0,200,255,0.3)] overflow-hidden">
                  <div className="p-4">
                ...
                {/* 右栏：个人实践思考 */}
                <div className="rounded-2xl bg-gray-900/70 border border-gray-700 shadow-[0_0_15px_rgba(147,51,234,0.3)] overflow-hidden">
                  <div className="p-4">
                    <h3 className="text-lg font-semibold text-gray-100 mb-4 flex items-center">
              ...
              <div className="h-[calc(100vh-8rem)] flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-to-r from-cyan-500/20 to-blue-600/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-cyan-500/30 shadow-[0_0_20px_rgba(6,182,212,0.3)]">
                  ...
                  <div className="flex justify-center space-x-4">
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-cyan-500/20 to-blue-600/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-cyan-500/30">
                    ...
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-500/20 to-purple-600/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-purple-500/30">
                    ...
                    <div className="text-center">
                      <div className="w-12 h-12 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg flex items-center justify-center mx-auto mb-2 border border-orange-500/30">
